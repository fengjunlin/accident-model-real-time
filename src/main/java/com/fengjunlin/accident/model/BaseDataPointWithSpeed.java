...
import com.fengjunlin.accident.tools.DataHander;
...
public class BaseDataPointWithSpeed implements Comparable<BaseDataPointWithSpeed> {
    ...
    public double getTimeCurrentSystemTime(Long currentTime) {
        // 两个计数点之间的时间，单位 s
        double timeBetweenTwoPoints = DataHander.getTimeBetweenTwoPoints(this.systemTime,currentTime);
        return timeBetweenTwoPoints;
    }
    ...
    public BaseDataPointWithSpeed(double lng, double lat, Long time, double speed, Long systemTime) {
        this.lng = lng;
        this.lat = lat;
        this.time = time;
        this.speed = speed;
